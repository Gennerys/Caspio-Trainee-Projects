...
INSERT INTO @WorkItemSeed([WorkItemId],[WorkItemTypeId],[Title],[DateOfClose],[Priority],[Description],[Estimate],[StateId],[AreaId],[UserId],[ParentWorkItem],[Timestamp],[IsDeleted])
VALUES
(1,3,'Develop Database',DEFAULT,1,'Develop TMS database, see message in Teams for more.',72,1,1,1,11,DEFAULT,DEFAULT),
(2,3,'Mentor Database',DEFAULT,2,'Mentor development of TMS database.',10,1,1,2,11,DEFAULT,DEFAULT),
(3,3,'Support customers',DEFAULT,1,'Give advice to new customers as fast as you can.',99,2,3,7,DEFAULT,DEFAULT,DEFAULT),
(4,3,'Find new employees',DEFAULT,3,'Find new employees among students or bachelors.',84,1,3,4,DEFAULT,DEFAULT,DEFAULT),
(5,3,'Merge branches',DEFAULT,1,'Merge up-to-date branches to production branch.',24,1,2,3,10,DEFAULT,DEFAULT),
(6,2,'Fix bugs in front-end branch',DEFAULT,2,'New bugs found in front-end branch, see comments in pull request.',48,3,1,6,10,DEFAULT,DEFAULT),
(7,2,'Front bug #1',DEFAULT,1,'Index page have 2 bugs',12,3,2,3,13,DEFAULT,DEFAULT),
(8,2,'Front bug #2',DEFAULT,2,'Admin page customer count bug',12,3,2,6,13,DEFAULT,DEFAULT),
(9,2,'Fix contraints in db',DEFAULT,1,'Fix FK constraints in Task_History',24,1,1,1,11,DEFAULT,DEFAULT),
(10,1,'Merge branches',DEFAULT,1,'Solve conflicts in dev and local branches',72,3,2,3,DEFAULT,DEFAULT,DEFAULT),
(11,1,'Database TMS update',DEFAULT,1,'See info in subtask',72,1,1,1,DEFAULT,DEFAULT,DEFAULT),
(12,1,'New Constraints',DEFAULT,2,'Develop properly working check constraints',28,1,1,1,DEFAULT,DEFAULT,DEFAULT),
(13,1,'Angular > React',DEFAULT,1,'Switch from React to Angular',56,2,2,3,DEFAULT,DEFAULT,DEFAULT)
...
WHEN NOT MATCHED THEN
INSERT ([WorkItemId],[WorkItemTypeId],[Title],[DateOfCreation],[DateOfClose],[Priority],[Description],[Estimate],[StateId],[AreaId],[UserId],[ParentWorkItem],[Timestamp])
VALUES(SOURCE.[WorkItemId],SOURCE.[WorkItemTypeId],SOURCE.[Title],
