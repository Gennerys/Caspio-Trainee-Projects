...
ALTER TABLE [dbo].[WorkItem]
    ADD DEFAULT GETUTCDATE() FOR [DateOfCreation];
...
--INSERT INTO @WorkItemSeed([WorkItemId],[WorkItemType],[Title],[DateOfCreation],[DateOfClose],[Priority],[Description],[Estimate],[StateId],[AreaId],[UserId],[ParentWorkItem],[Timestamp])
--VALUES
--(1,3,'Develop Database',DEFAULT,DEFAULT,1,'Develop TMS database, see message in Teams for more.',72,1,1,1,DEFAULT,DEFAULT),
--(2,3,'Mentor Database',DEFAULT,DEFAULT,2,'Mentor development of TMS database.',10,1,1,2,DEFAULT,DEFAULT),
...
--(5,'Merge branches',GETDATE(),1,'Merge up-to-date branches to production branch.',24,1,2,3,DEFAULT,DEFAULT),
--(6,'Fix bugs in front-end branch',GETDATE(),2,'New bugs found in front-end branch, see comments in pull request.',48,3,1,6),
--(7,'Front bug #1',GETDATE(),1,'Index page have 2 bugs',12,3,2,3),
--(8,'Front bug #2',GETDATE(),2,'Admin page customer count bug',12,3,2,6),
--(9,'Fix contraints in db',GETDATE(),1,'Fix FK constraints in Task_History',24,1,1,1),
--(10,'Merge branches',GETDATE(),1,'Solve conflicts in dev and local branches',72,3,2,3),
--(11,'Database TMS update',GETDATE(),1,'See info in subtask',72,1,1,1),
--(12,'New Constraints',GETDATE(),2,'Develop properly working check constraints',28,1,1,1),
--(13,'Angular > React',GETDATE(),1,'Switch from React to Angular',56,2,2,3)
