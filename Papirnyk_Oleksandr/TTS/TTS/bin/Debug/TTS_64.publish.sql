...
GO
PRINT N'Altering [dbo].[WorkItemCurrentState]...';


GO
ALTER VIEW [dbo].[WorkItemCurrentState]
	AS

	SELECT
	 LAST_VALUE(Timestamp) OVER (PARTITION BY [WorkItemId] ORDER BY [RevisionId] DESC RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING  ) as LastRevision
	,[RevisionId]
    ,[WorkItemId]
    ,[WorkItemTypeId]
    ,[Title]
