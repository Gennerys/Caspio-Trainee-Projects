...
--(SELECT * FROM (VALUES
--(1, N'AF', N'Agriculture', 1, 3),
--...
--) AS s ([industry_id], [industry_code], [industry_name], [active], [display_order])) AS [Source]
...
(9,7,3),
(10,8,3),
(11,8,6) )  AS Seed([Id],[WorkItemId],[UserId])) AS SOURCE
ON TARGET.[Id] = SOURCE.[Id]
WHEN MATCHED THEN
UPDATE SET
TARGET.[WorkItemId] = SOURCE.[WorkItemId],
TARGET.[UserId] = SOURCE.[UserId]
WHEN NOT MATCHED THEN
INSERT ([Id],[WorkItemId],[UserId])
VALUES(SOURCE.[Id],SOURCE.[WorkItemId],SOURCE.[UserId]);
