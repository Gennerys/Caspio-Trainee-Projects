...
END
GO
PRINT N'Altering [dbo].[AddWorkItem]...';


GO
ALTER PROCEDURE [dbo].[AddWorkItem]
	@WorkItemId INT,
    @WorkItemTypeId INT,
    @Title VARCHAR(200),
    @StateId INT,
...
BEGIN
	SET NOCOUNT ON;
		...
		IF NOT EXISTS (SELECT WorkItemId,WorkItemTypeId,Title,StateId,AreaId FROM [TTS].[dbo].[WorkItem] 
      WHERE WorkItemId=@WorkItemId AND WorkItemTypeId=@WorkItemTypeId AND Title = @Title
		AND StateId = @StateId AND AreaId = @AreaId) 
	BEGIN
	...
	END
		ELSE
		BEGIN
		 RAISERROR('This workitem already exists', 16,16)
		END

END
GO
PRINT N'Altering [dbo].[GetCommentsByUser]...';


GO
ALTER PROCEDURE [dbo].[GetCommentsByUser]
	@UserId int
AS
BEGIN
...
END
GO
PRINT N'Altering [dbo].[SubscribeToWorkItem]...';


GO
ALTER PROCEDURE [dbo].[SubscribeToWorkItem]
	@WorkItemId int,
	@UserId int
AS
BEGIN
...
BEGIN
	SET NOCOUNT ON;
	INSERT INTO [dbo].[WorkItem] ([WorkItemId]
      ,[WorkItemTypeId]
      ,[Title]
      ,[StateId]
      ,[AreaId])
