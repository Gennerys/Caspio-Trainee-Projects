...
BEGIN
	SET NOCOUNT ON;
	INSERT INTO [TTS].[dbo].[User] (FirstName, LastName, Email, Title)
...
BEGIN
	SET NOCOUNT ON;
	--if exists check
	INSERT INTO [TTS].[dbo].[WorkItem] (WorkItemId,WorkItemTypeId,Title,StateId,AreaId)
	VALUES (@WorkItemId,@WorkItemTypeId,@Title,@StateId,@AreaId)
END
GO
...
AS
BEGIN
	INSERT INTO [TTS].[dbo].[SubscribedToWorkItem] (WorkItemId,UserId)
...
[TTS].[dbo].[WorkItem].[AssignedUserId] = ISNULL([AssignedUserId],@UserId), [TTS].[dbo].[WorkItem].[ParentWorkItem] = ISNULL([ParentWorkItem],@ParentWorkItem),
