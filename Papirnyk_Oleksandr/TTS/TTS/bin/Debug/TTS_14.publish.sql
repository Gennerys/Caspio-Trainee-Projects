...
BEGIN
	...
	VALUES (@WorkItemId,@WorkItemTypeId,@Title,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,@StateId,@AreaId,DEFAULT,DEFAULT,DEFAULT,DEFAULT)
END
GO
/*
...
INSERT INTO @WorkItemSeed([WorkItemId],[WorkItemTypeId],[Title],[DateOfCreation],[DateOfClose],[Priority],[Description],[Estimate],[StateId],[AreaId],[UserId],[ParentWorkItem],[Timestamp],[IsDeleted])
VALUES
