...
SET [TTS].[dbo].[WorkItem].[DateOfClose] = coalesce([DateOfClose],@DateOfClose), [TTS].[dbo].[WorkItem].[Priority] = coalesce([Priority],@Priority),
[TTS].[dbo].[WorkItem].[Description] = @Description, [TTS].[dbo].[WorkItem].[Estimate] = @Estimate,
[TTS].[dbo].[WorkItem].[UserId] = @UserId, [TTS].[dbo].[WorkItem].[ParentWorkItem] = @ParentWorkItem,
[TTS].[dbo].[WorkItem].[IsDeleted] = @IsDeleted
WHERE [TTS].[dbo].[WorkItem].[WorkItemId] = @WorkItemId
