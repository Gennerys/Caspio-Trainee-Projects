...
GO
PRINT N'Creating [dbo].[UniqueUser]...';


GO
ALTER TABLE [dbo].[User]
    ADD CONSTRAINT [UniqueUser] UNIQUE NONCLUSTERED ([FirstName] ASC, [LastName] ASC);
...
BEGIN
	SET NOCOUNT ON;
		...
		IF NOT EXISTS (SELECT WorkItemId,WorkItemTypeId,Title,StateId,AreaId FROM [dbo].[WorkItem] 
